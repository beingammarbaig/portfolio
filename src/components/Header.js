  ...
  return (
    <div className="container" id="header">
      <div className="mt-2 d-flex justify-content-between align-items-center">
        ...
        >
          <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-full flex items-center justify-center text-accent font-primary font-bold text-[14px] lg:text-[16px] tracking-wider"
            style={{ background: "linear-gradient(135deg, rgba(255,86,246,0.15), rgba(185,54,238,0.15))", border: "1.5px solid rgba(255,86,246,0.45)" }}>
            FA
          </div>
        </motion.div>
        <motion.div
